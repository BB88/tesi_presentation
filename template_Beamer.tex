...
\begin{column}{5cm}
\begin{figure}
\includegraphics[width=0.85\linewidth]{./img/views_domain.jpeg}
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\item Vantaggi:
	...
	\end{itemize}
\item Il watermark viene inserito nella vista destra considerando la mappa di disparit\`{a}
\end{itemize}
\end{center}
\end{frame}
...
$ \mathbf{f_{r}^{w} = f_{r}+\alpha w^{*}_{K}}$
\end{itemize}
\end{block}
\end{column}
\begin{column}{5cm}
...
\begin{center}
\begin{figure}
\includegraphics[width=0.9\linewidth]{/home/bene/Scrivania/p2.png}
\end{figure}
\end{center}
\end{column}
\end{columns}
...
Si puo' ottenere in due modi:
\begin{itemize}
\item[1.] Correlazione \textbf{vista destra} e \textbf{marchio distorto}
\item[2.] Correlazione vista sinistra ricostruita attraverso la vista destra e il marchio originale
\end{itemize}
\end{block}
\end{column}
\begin{column}{5cm}
