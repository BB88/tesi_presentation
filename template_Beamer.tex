...
\begin{center}
  \scalebox{0.8}{%
$\boldsymbol{ l =  \frac{1}{MN}\sum\sum(|L(u,v)|)\exp\{\phi (u,v)\} \exp\{-j2\pi(\frac{ux}{M}+\frac{vy}{N})\}  }$
  }
\end{center}
...
\begin{center}
  \scalebox{0.8}{%
$\boldsymbol{ l_{w} = \frac{1}{MN}\sum\sum(|L(u,v)| + \alpha|L(u,v)||w|)\exp\{j(\phi_{L}+\phi_{w})\}\exp\{-j2\pi(\frac{ux}{M}+\frac{vy}{N})\}} $
  }
\end{center}
...
\begin{center}
  \scalebox{0.8}{%
$\boldsymbol{ r_{w} = r + \frac{1}{MN}\sum\sum(\alpha|R(u,v)||w|\exp\{j(\phi_{R}+\phi_{w})\})\exp\{-j2\pi(\frac{ux}{M}+\frac{vy}{N})\}} $
  }
\end{center}
...
\begin{center}
  \scalebox{0.8}{%
$\boldsymbol{ \alpha|L||w|exp\{j(\phi_{L}+\phi{w})\}} $
  }
\end{center}
\end{itemize}}
\end{block}
...
\begin{center}
  \scalebox{1}{%
$\boldsymbol{  \alpha|R^{**}||w|exp\{j(\phi_{L}+\phi{w})\} }$
  }
\end{center}
\vspace{3mm}
...
\begin{center}
  \scalebox{0.9}{%
$\boldsymbol{ l_{w} = l + \frac{1}{MN}\sum\sum(\alpha|L(u,v)||w|\exp\{j(\phi_{L}+\phi_{w})\})\exp\{-j2\pi(\frac{ux}{M}+\frac{vy}{N})\} }$
